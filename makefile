...
##
uninstall:
	$(shell	mv install_files/ast_vanilla_stan.hpp  ../stan_2.9.0/src/stan/lang/ast.hpp && \
	mv install_files/ast_def_vanilla_stan.cpp  ../stan_2.9.0/src/stan/lang/ast_def.cpp && \
	mv install_files/makefile_vanilla_stan ../makefile && \
	mv install_files/function_signatures_vanilla_stan.h ../stan_2.9.0/src/stan/lang/function_signatures.h)
	$(shell	mv install_files/math_vanilla_stan.hpp ../stan_2.9.0/lib/stan_math_2.7.0/stan/math.hpp)

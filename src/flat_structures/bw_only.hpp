#ifndef STAN_PWA__SRC__FLAT_FLAT_STRUCTURES__THREE_BODY__BW_ONLY_HPP
#define STAN_PWA__SRC__FLAT_FLAT_STRUCTURES__THREE_BODY__BW_ONLY_HPP
...
namespace resonances {
  ...
  struct breit_wigner_only : public mresonances::resonance_base_3
  {

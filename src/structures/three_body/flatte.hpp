#ifndef STAN_PWA__SRC__STRUCTURES__THREE_BODY__FLATTE_HPP
#define STAN_PWA__SRC__STRUCTURES__THREE_BODY__FLATTE_HPP
...
namespace resonances {
  ...
  struct flatte : mresonances::resonance_base_3
  {

...
if 'num_background' in dir(model):
    ...
    av_background_abs2_data_ = np.asarray([utils.convert_to_vector(model.av_background_abs2(model.num_background(), y_data_[:,d].tolist())) for d in range(D_)])
...
if 'I_background_' in locals():
    data = dict(D = D_, y_data = y_data_, amplitude_vector_data = amplitude_vector_data_, I = I_out_,
                av_background_abs2_data = av_background_abs2_data_,

...
parameters {
  ...
  real<lower=0., upper=5.> theta_m_f0_1200;
  real<lower=-pi(), upper=pi()> theta_phi_f0_1200;
...
transformed parameters {
  ...
  theta[2,1] <- 0.0;
  theta[1,2] <- theta_m_f0_1200 * cos(theta_phi_f0_1200);
  theta[2,2] <- theta_m_f0_1200 * sin(theta_phi_f0_1200);
...
model {
  ...
  // Specify non-flat priors
  theta_background_rho_770_abs2 ~ normal(28.,3.);
